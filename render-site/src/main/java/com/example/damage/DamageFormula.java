...
public class DamageFormula {
    ...
    private static double core(int level, int power, float attack, float defense) {
        // Use doubles to avoid integer-division truncation
        return level * (power / 10.0) * ((double) attack / Math.max(defense, 1));
    }


    public static int formulaSESTABNC(int level, int power, float attack, float defense,
                                     double superEffectiveLevel, double stabLevel) {
        return asInt(core(level, power, attack, defense) * stabLevel * superEffectiveLevel);
    }

    public static int formulaSESTABCrit(int level, int power, float attack, float defense,
                                        double superEffectiveLevel, double stabLevel) {
        return asInt(core(level, power, attack, defense) * stabLevel * superEffectiveLevel * 2.0);
    }

    public static int formulaSENC(int level, int power, float attack, float defense,
                                 double superEffectiveLevel) {
        return asInt(core(level, power, attack, defense) * superEffectiveLevel);
    }

    public static int formulaSECrit(int level, int power, float attack, float defense,
                                   double superEffectiveLevel) {
        return asInt(core(level, power, attack, defense) * superEffectiveLevel * 2.0);
    }

    public static int formulaNVESTABNC(int level, int power, float attack, float defense,
    ...
    public static int formulaNVESTABCrit(int level, int power, float attack, float defense,
                                         double notVeryEffectiveLevel, double stabLevel) {
        return asInt(core(level, power, attack, defense) * stabLevel * notVeryEffectiveLevel * 2.0);
    }

    public static int formulaNVENC(int level, int power, float attack, float defense,
                                   double notVeryEffectiveLevel) {
        return asInt(core(level, power, attack, defense) * notVeryEffectiveLevel);
    }

    public static int formulaNVECrit(int level, int power, float attack, float defense,
                                     double notVeryEffectiveLevel) {
        return asInt(core(level, power, attack, defense) * notVeryEffectiveLevel * 2.0);
    }

    public static int formulaSTABNC(int level, int power, float attack, float defense,
                                    double stabLevel) {
        return asInt(core(level, power, attack, defense) * stabLevel);
    }

    public static int formulaSTABCrit(int level, int power, float attack, float defense,
                                      double stabLevel) {
        return asInt(core(level, power, attack, defense) * stabLevel * 2.0);
    }

    public static int formulaBase(int level, int power, float attack, float defense) {
        return asInt(core(level, power, attack, defense));
    }

    public static int formulaBaseCrit(int level, int power, float attack, float defense) {
